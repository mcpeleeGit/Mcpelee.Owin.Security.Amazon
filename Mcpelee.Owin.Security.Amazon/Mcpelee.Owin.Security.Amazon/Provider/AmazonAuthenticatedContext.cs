...
namespace Mcpelee.Owin.Security.Amazon
{
    ...
    public class AmazonAuthenticatedContext : BaseContext
    {
        ...
        /// <param name="accessToken">Amazon Access token</param>
        /// <param name="expires">Seconds until expiration</param>
        public AmazonAuthenticatedContext(IOwinContext context, JObject user, string accessToken, string expires)
            : base(context)
        {
            User = user;
        ...
        /// <summary>
        /// Gets the Amazon username
        /// </summary>
        public string UserName { get; private set; }

        /// <summary>
        /// Gets the Amazon email
        /// </summary>
