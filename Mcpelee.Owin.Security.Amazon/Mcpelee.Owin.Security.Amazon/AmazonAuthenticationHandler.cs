...
{
    internal class AmazonAuthenticationHandler : AuthenticationHandler<AmazonAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new AmazonAuthenticatedContext(Context, user, accessToken, expires);
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:amazon:name", context.Name, XmlSchemaString, Options.AuthenticationType));

                    // Many Amazon accounts do not set the UserName field.  Fall back to the Name field instead.
                    if (string.IsNullOrEmpty(context.UserName))
                    {
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:amazon:link", context.Link, XmlSchemaString, Options.AuthenticationType));
                }
